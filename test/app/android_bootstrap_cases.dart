  ...
  for (final environment in [
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.pumpAndSettle();
        expect(
          PresentationScope.of(tester.element(find.byType(AndroidConnectPage))),
          environment,
        );
        expect(find.text(server.baseUrl.toString()), findsOneWidget);
        final submit = find.byKey(const Key('android-connect-submit'));
